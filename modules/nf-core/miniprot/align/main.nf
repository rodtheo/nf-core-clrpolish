process MINIPROT_ALIGN {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/miniprot:0.18--h577a1d6_0':
        'biocontainers/miniprot:0.18--h577a1d6_0' }"
    ...
    tuple val(meta2), path("*.gff"), optional: true, emit: gff
